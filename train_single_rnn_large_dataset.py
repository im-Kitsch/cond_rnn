...
from model.single_rnn import SingleGRU
...
cond_gru = SingleGRU(NUM_CLASS, hid_size=args.hid_size, hid_layers=args.hid_layer,
...
model_summary = torchsummaryX.summary(cond_gru, test_dt)
