...
# do not add <SOS> for this class
class CondPlusInitPlaceGRU(BaseRNN):
    def __init__(self, num_class, hid_size, hid_layers, drop_out_rate,
        ...
        super(CondPlusInitPlaceGRU, self).__init__(data_keys=data_keys, writer_comment=writer_comment)
        ...
        self.gru = torch.nn.GRU(
            input_size=embedding_size + emb_cond_size1 + emb_cond_size2 + emb_cond_size3 + embedding_size,
    ...
    def forward(self, input_data, condition, h0=None):
        ...
        cond4 = embeded_data[[0]]

        cond = torch.cat([cond1, cond2, cond3, cond4], dim=2)
