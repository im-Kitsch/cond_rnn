...
class CondGruAttention(torch.nn.Module):
    def __init__(self, num_class, hid_size,
                 embedding_size, cond_range, emb_cond_size,
                 learning_rate):
        super(CondGruAttention, self).__init__()
    ...
    def eval_perplexity(self, data_loader, device):
        ...
        for i_bt, (batch_data, batch_label, batch_cond) in enumerate(data_loader):
            ...
            logits, _, _ = self.forward(batch_data, batch_cond)
